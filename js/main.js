var count = 0;//变量：保存加载图片的数量
var sum;//用于保存计算后的百分比的值
...
$(document).ready(function(){
  //图片预加载
  // var $img = $('img');//获取页面中所有的图片
  // var max_count = $img.length;//计算图片的数量
  // //遍历$img数组
  ...
  //       count++;//count自增1
  //       console.log(count);
  //       sum = parseInt(count/max_count*100)+"%";//计算百分比值
  //       $('.start span').html(sum);//在页面上$('.start span')显示百分比
  //       //如果count对于图片的数量，则表示图片加载完成。
  //       if(count==max_count){
  //         //你可以在此处执行你的主函数，或者你想执行的东西
  ...
  //   };
  //   //用法 
  //   $.preloadImages('imgs/one/block.png','imgs/one/img4.png','imgs/one/resume.png','imgs/one/R.png','imgs/one/s.png','imgs/one/e.png','imgs/one/geren.png','imgs/one/jian.png','imgs/one/cd.png','imgs/slide.png','imgs/one/l1.png','imgs/one/l2.png','imgs/one/l3.png','imgs/two/1.gif','imgs/bg.png','imgs/bg1.png','imgs/music.png','imgs/musicoff.png');
  //   
